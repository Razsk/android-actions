...
class OptimizationCardAnalyzerTest {
    ...
    fun testAnalyzePostponementHistory_triggersSuggestionCard_whenPostponed3Times() {
        ...
        val logs = listOf(
            TaskExecutionLog(id = 1L, taskId = 10L, actionType = "POSTPONED", timestamp = 100L),
            TaskExecutionLog(id = 2L, taskId = 10L, actionType = "POSTPONED", timestamp = 200L),
            TaskExecutionLog(id = 3L, taskId = 10L, actionType = "POSTPONED", timestamp = 300L)
        )
    ...
    fun testAnalyzePostponementHistory_returnsNull_whenPostponedLessThan3Times() {
        ...
        val logs = listOf(
            TaskExecutionLog(id = 1L, taskId = 10L, actionType = "POSTPONED", timestamp = 100L),
            TaskExecutionLog(id = 2L, taskId = 10L, actionType = "COMPLETED", timestamp = 200L)
        )
